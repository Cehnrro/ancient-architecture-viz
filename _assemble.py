...
script_path = "D:/jishe/ancient-architecture-viz/_script.txt"
style_path  = "D:/jishe/ancient-architecture-viz/_style.txt"
out_path    = "D:/jishe/ancient-architecture-viz/src/views/ExploreView.vue"
...
'    <nav class="top-nav">',
'      <span class="nav-title text-glow-gold" v-text="\'匠心千年\'" />',
'      <div class="nav-links">',
'        <router-link to="/explore" v-text="\'建筑地图\'" />',
'        <router-link to="/works" v-text="\'文化著作\'" />',
'        <router-link to="/lineage" v-text="\'科学家谱系\'" />',
'      </div>',
'    </nav>',
'',
'    <div class="main-body">',
...
'            </div>',
'            <div class="bc-actions" v-if="selectedBuilding.isFeatured">',
'              <button',
'                class="detail-btn"',
